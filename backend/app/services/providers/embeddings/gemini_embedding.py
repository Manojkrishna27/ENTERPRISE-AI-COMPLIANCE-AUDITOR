    ...
    def get_embedding(self, text: str) -> tuple[list[float], float]:
        ...
        try:
            ...
            if res.status_code != 200:
                print(
                    f"Gemini Embedding API status {res.status_code}. Using deterministic fallback vector."
                )
            ...
            print(f"Failed to generate Gemini embedding: {e!s}. Using fallback vector.")
            return [0.01] * self.dimension, 0.05
