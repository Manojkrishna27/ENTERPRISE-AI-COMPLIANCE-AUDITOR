...
class GeminiLLMProvider(BaseLLMProvider):
    ...
    def _resolve_model(self):
        try:
            ...
            preferred_order = ["gemini-1.5-flash", "gemini-1.5-flash-latest", "gemini-1.5-pro", "gemini-pro"]
            ...
            print(f"Failed to resolve Gemini chat models: {e}. Falling back to default.")
            self._active_model = "gemini-1.5-flash"
    ...
    def _call_gemini_native(self, system_prompt: str, user_prompt: str, temperature: float, is_json: bool = False):
