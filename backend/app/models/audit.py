...
class AIFinding(db.Model):
    ...
    )  # Missing Clause, GDPR, Payment, Liability, etc.
    ...
    policy_id = db.Column(
        db.String(36), db.ForeignKey("policies.id", ondelete="SET NULL"), nullable=True
    )
...
class Report(db.Model):
    ...
    report_type = db.Column(
        db.String(50), nullable=False
    )  # Executive Summary, Compliance Report, Risk Heatmap, Audit Trail
