...
class Config:
    ...
    # Redis Configuration
    REDIS_URL = os.environ.get('REDIS_URL', 'redis://redis:6379/0' if is_docker else 'redis://localhost:6379/0')
    ...
    if is_docker:
        ...
        LOCAL_STORAGE_DIR = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), 'uploads')
    ...
    MAIL_DEFAULT_SENDER = os.environ.get('MAIL_DEFAULT_SENDER', 'noreply@contractcompliance.com')
