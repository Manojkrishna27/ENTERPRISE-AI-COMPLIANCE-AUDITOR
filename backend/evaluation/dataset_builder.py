...
def build_dataset():
    ...
    standard_queries = [
        (
            "What is the maximum liability limit under the Master Service Agreement?",
            "MSA",
            "GDPR",
            "Section 2 states liability shall not exceed $1,000,000.",
            2,
            2,
            "LOW",
        ),
        (
            "What is the data breach notification requirement in the Data Processing Agreement?",
            "DPA",
            "GDPR",
            "Notification of data breaches must be sent within 24 hours of discovery.",
            4,
            2,
            "HIGH",
        ),
        (
            "Does the Vendor Agreement require cyber liability insurance?",
            "Vendor",
            "SOC2",
            "Yes, Section 3 requires minimum $5,000,000 Cyber Liability Insurance.",
            3,
            1,
            "MEDIUM",
        ),
        (
            "What SLA uptime is guaranteed in the Vendor Service Agreement?",
            "Vendor",
            "SOC2",
            "Section 1 guarantees an SLA uptime of 99.9%.",
            1,
            1,
            "LOW",
        ),
        (
            "What are the payment terms in the Master Service Agreement?",
            "MSA",
            "SOC2",
            "Section 4 specifies invoices are payable net 30 days with 1.5% monthly late interest.",
            4,
            1,
            "LOW",
        ),
        (
            "What is the duration of confidentiality obligations in the NDA?",
            "NDA",
            "SOC2",
            "Section 2 specifies receiving party agrees to hold information in confidence for 5 years.",
            2,
            1,
            "MEDIUM",
        ),
        (
            "What encryption standards are required by the DPA and SOC2 policy?",
            "DPA",
            "SOC2",
        ...
        (
            "What is the incident response time requirement for Severity 1 security incidents?",
            "Service",
            "SOC2",
            "Section 2 requires a response within 15 minutes.",
            2,
            1,
            "HIGH",
        ),
        (
            "What is the delivery inspection window under the Purchase Agreement?",
            "Purchase",
            "SOC2",
            "Section 2 allows 14 calendar days upon delivery to inspect and reject defective hardware.",
            2,
            1,
            "LOW",
        ),
        (
            "What fixed fee and milestone payments are specified in the Statement of Work?",
            "SOW",
            "SOC2",
            "Total fixed fee of $250,000: $100k at architecture signoff, $150k at final acceptance.",
            2,
            1,
            "MEDIUM",
        ),
        (
            "Does the Employment Agreement include a non-compete clause?",
            "Employment",
            "SOC2",
            "Yes, Section 2 includes a 12-month non-compete within 50 miles.",
            2,
            1,
            "MEDIUM",
        ),
        (
            "How long must production audit logs be retained according to SOC2 policy?",
            "MSA",
            "SOC2",
            "SOC2 Section 3 mandates retention for at least 365 days.",
            1,
            3,
            "HIGH",
        ),
        (
            "What is the penalty if vendor uptime falls below 99.5%?",
            "Vendor",
            "SOC2",
            "Section 2 requires a 15% billing credit.",
            2,
            1,
            "MEDIUM",
        ),
        (
            "What are the data subject deletion request timeframes under GDPR?",
            "DPA",
            "GDPR",
        ...
        (
            "What penetration testing frequency is required by ISO 27001 policy?",
            "MSA",
            "ISO27001",
            "Penetration testing must occur at least annually.",
            1,
            1,
            "HIGH",
        ),
        (
            "Are sub-processors allowed under the DPA without approval?",
            "DPA",
            "GDPR",
            "No, Processor shall not engage sub-processors without prior written authorization.",
            2,
            1,
            "HIGH",
        ),
        (
            "What warranty period is provided for hardware under the Purchase Agreement?",
            "Purchase",
            "SOC2",
            "3-year full replacement warranty for defective parts.",
            3,
            1,
            "LOW",
        ),
        (
            "What severance is offered under the Employment Agreement?",
            "Employment",
            "SOC2",
            "2 months salary upon termination without cause.",
            3,
            1,
            "LOW",
        ),
        (
            "What data storage rules apply to credit card PAN numbers under PCI DSS?",
            "Purchase",
            "PCI_DSS",
            "PAN must be masked, hashed, or encrypted; storing CVV post-authorization is prohibited.",
            1,
            1,
            "CRITICAL",
        ),
        (
            "How far in advance must notice be given to terminate the MSA?",
            "MSA",
            "SOC2",
        ...
        dataset.append(
            {
                ...
                "expected_citations": [
                    f"{base[1]} Page {base[4]}",
                    f"{base[2]} Page {base[5]}",
                ],
                "risk_level": base[6],
                "department_id": "legal",
            }
    ...
    edge_cases = [
        (
            "Very Long Question",
            "What is the liability policy " + "and warranty clause " * 200 + "?",
        ),
        ("Empty Query", ""),
        (
            "Out of Domain",
            "What is the capital of France and best recipe for chocolate cake?",
        ),
    ]
    for idx in range(15):
    ...
    print(
        f"✅ Ground truth dataset created successfully with {len(dataset)} items at {out_file}"
    )
    return dataset
